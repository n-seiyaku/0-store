...
const LOVE_LINES = ['Hôm nay em muốn uống gì?', 'Uống gì chọn đi ❤️']
        ...
        <div className="min-h-screen bg-[#081d35]">
            ...
            <section className="px-4 pb-24">
                <div className="container mx-auto max-w-4xl">
                    {/* Subtle label */}
                    <p className="mb-8 text-center text-xs font-semibold tracking-widest text-blue-100/25 uppercase">
                        Chọn thương hiệu
                    </p>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {brands.map((brand: Brand, index: number) => {
                            ...
                            const emoji =
                                BRAND_EMOJI[index % BRAND_EMOJI.length]
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Accent dot */}
                                    <div
                                        className={`h-2 w-2 shrink-0 rounded-full opacity-40 transition-opacity duration-300 group-hover:opacity-100 ${accent.dot}`}
                                    />
                                </Link>
                            )
                        })}
